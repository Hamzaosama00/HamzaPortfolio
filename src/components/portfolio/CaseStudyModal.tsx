 ...
 *  - Focus trapped inside modal (basic)
 *  - ARIA dialog role
 */
...
/* ============================================================
 * DAVAAM CASE STUDY CONTENT
 * ============================================================
 * Structured as scrollable sections inside the modal panel.
 */
    ...
    <article className="relative">
      ...
      <Section index="03" title="Approach">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <StepCard
            num="01"
            title="Structure"
            body="Semantic HTML, CSS Grid, mobile-first responsive breakpoints."
          />
          <StepCard
            num="02"
            title="Motion"
            body="GSAP timelines for reveals, hovers, and gallery transitions."
          />
          <StepCard
            num="03"
            title="Polish"
            body="Easing curves, kerning, and asset optimization."
          />
        </div>
      </Section>
      ...
      <Section index="04" title="Key Features">
        <div className="space-y-3">
          {[
            {
              t: "Section-based reveal choreography",
              d: "Each section enters on a staggered timeline as it crosses the viewport, with easing tuned to feel unhurried.",
            },
            {
              t: "Matched typography & spacing system",
              d: "Rebuilt the original's type scale and vertical rhythm from measurement, not guesswork.",
            },
            {
              t: "Responsive across breakpoints",
              d: "Layout reflows cleanly from 320px mobile to 4K desktop without losing the brand's composure.",
            },
            {
              t: "Optimized asset pipeline",
              d: "Images compressed and lazy-loaded; the site scores well on Core Web Vitals despite the motion.",
            },
          ].map((f) => (
